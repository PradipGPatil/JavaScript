...
const renderMovie = (filter = '') => {
  ...
  /// *** here we used object destructuring
  filterMovie.forEach((movie, idx, movies) => {
    ...
    // similarly we can do object destructuring here as well
    // we can give our custom name to the property if it is clase with other property
